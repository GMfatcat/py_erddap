...
# Download GFS to check
save_dir = r'C:\Users\user\Desktop\py_erddap'
d1 = Downloader(name = 'test_downloader')
d1.set_up(targetDataset_dictionary = gfs_dict,targetDataset_org_url = gfs_org_url)
d1.define_url_and_output_filename(saving_dir = save_dir, suffix = 'gfs')
last_check_before_download(d1)
d1.run()
